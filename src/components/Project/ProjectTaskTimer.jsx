    ...
    <div className={styles.container}>
      ...
      <div className={styles.leftColumn}>
        ...
        <p className={styles.description}>
          ...
          die Zeit für verschiedene Aufgaben zu verfolgen. Im{" "}
          <strong>Front-End</strong> kommen <strong>React</strong> und 
          <strong> CSS Modules</strong> zum Einsatz, während im{" "}
          <strong>Back-End</strong> <strong>Node.js</strong> und 
          <strong> MongoDB</strong> verwendet werden.
        </p>
